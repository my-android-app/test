...
public class PagerIndicator extends LinearLayout {
    ...
    public PagerIndicator(Context context) {
        this(context, null);
        setDefaultIndicatorShape(Shape.Oval);
        setDefaultIndicatorColor(Color.rgb(255, 255, 255), Color.argb(33, 255, 255, 255));
        setDefaultIndicatorSize(6, 6, Unit.DP);
        setDefaultPadding(3, 0, 3, 0, Unit.DP);
    }
...
//    }
    ...
    private void resetDrawable() {
        for (View i : mIndicators) {
            if (mSelectedIndicator != null && mSelectedIndicator.equals(i)) {
...
//        }
//        setItemAsSelected(mSelectedPosition);
//    }
